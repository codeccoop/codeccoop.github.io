document.addEventListener("DOMContentLoaded", function() {
    ...
    var frames = [
        ...
        ['<h1 class="title is-1">Còdec</h1>', 600],
        ['<h1 class="title is-1">Còdec<span class="cursor"></span></h1>', 600],
        ['<h1 class="title is-1">Còdec</h1>', 600],
        ['<h1 class="title is-1">Còdec<span class="cursor highlight"></span></h1>', 600],
        ['<h1 class="title is-1">Còde<span class="cursor highlight"></span><span class="bytes">11</span></h1>', 600],
        ...
        ['<h1 class="title is-1"><span class="bytes">1100100111</span></h1>', 600],
        ['<h1 class="title is-1"><span class="cursor"></span><span class="bytes">1100100111</span></h1>', 600],
        ['<h1 class="title is-1">C<span class="cursor"></span><span class="bytes">00100111</span></h1>', 200],
